...
export function TopBar({
  ...
  return (
    <div 
      className="h-16 sticky top-0 flex items-center px-6 border-b border-gray-200 bg-background justify-between"
      style={{ 
    ...
    >
      ...
      <Button size="default" variant={"ghost"} className="h-10 px-4">
        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-4 w-4">
